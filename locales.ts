...
export const TRANSLATIONS = {
  fr: {
    ui: {
      ...
      etre_gender_sing: "Féminin : ajoutez -e → {form}",
      etre_gender_plural: "Féminin pluriel : ajoutez -es → {form}",
      ...
      tour_header_desc: "Cliquez sur la roue dentée pour sélectionner les temps verbaux que vous souhaitez pratiquer. Pour commencer, seuls le Présent, le Passé Composé et l'Imparfait sont activés.",
      ...
      tour_about_title: "Tout est prêt",
      tour_about_desc:"Besoin d’aide plus tard ? Vous pouvez redémarrer ce tutoriel à tout moment en cas de problème.",
  ...
  en: {
    ui: {
      ...
      regular: "Regular",
      irregular: "Irregular",
      etre_gender_sing: "Feminine: add -e → {form}",
      etre_gender_plural: "Feminine plural: add -es → {form}",
      ...
      tour_header_desc: "Click here to select which tenses you want to practice. To start, we've only selected the basics (Present, Compound Past, Imperfect).",
      tour_obj_title: "The Goal",
      tour_obj_desc: "The Verb and Tense and Person you need to conjugate.",
      tour_tray_title: "The Puzlle Pieces",
      tour_tray_desc: "Find the correct parts (Stem & Ending) in this tray.",
      tour_zone_title: "Puzzle it",
      tour_zone_desc: "Drag or Click the pieces here to build the conjugation word.",
      ...
      tour_about_title: "You're All Set",
      tour_about_desc:"Need help later? You can restart this tutorial anytime if you run into problems.",
      // Onboarding Modal
  ...
  zh: {
    ui: {
      ...
      regular: "规则",
      irregular: "不规则",
      etre_gender_sing: "阴性：加 -e → {form}",
      etre_gender_plural: "阴性复数：加 -es → {form}",
      ...
      tour_header_desc: "点击这个齿轮图标，你可以自由选择设置想要练习的时态。为了便于上手，默认仅开启了三个基础时态（现在时、复合过去时、未完成过去时）",
      tour_obj_title: "当前目标",
      tour_obj_desc: "这里显示需要变位的 人称代词 + 动词 + 时态",
      tour_tray_title: "词干词尾拼图",
      tour_tray_desc: "在下方区域找到正确的词干(Stem)和词尾(Ending), 组合成正确的动词变位词。 ",
      tour_zone_title: "开拼！",
      tour_zone_desc: "将词干词尾拼图拖拽到这里，组合成正确的动词变位。",
      ...
      tour_about_title: "已完成教程",
      tour_about_desc:"之后如果需要帮助，遇到问题时可随时重新开始本教程。",
  ...
  ja: {
    ui: {
      ...
      regular: "規則",
      irregular: "不規則",
      etre_gender_sing: "女性形：-e を追加 → {form}",
      etre_gender_plural: "女性複数形：-es を追加 → {form}",
      ...
      tour_header_desc: "この歯車アイコンをクリックして、練習したい時制を自由に選べます, 最初は基本の時制（現在形、複合過去、半過去）のみ選択されています",
      ...
      tour_about_title: "チュートリアル完了",
      tour_about_desc: "後でサポートが必要な場合や問題が発生した場合は、いつでもこのチュートリアルを再開できます。",
      // Onboarding Modal
