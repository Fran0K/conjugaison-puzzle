...
export const TRANSLATIONS = {
  ...
  en: {
    ui: {
      ...
      tour_header_desc: "Click the gear icon to select which tenses you want to practice. To start, we've only selected the basics (Present, Compound Past, Imperfect).",
