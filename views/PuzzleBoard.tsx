      ...
      <div className="relative inline-block w-full max-w-lg" ref={objectiveRef}>
        <div className="bg-white px-4 py-5 sm:px-12 sm:py-6 rounded-3xl relative overflow-hidden transition-all duration-300">
          ...
          <button
              ...
              className={`absolute bottom-2 right-2 p-2.5 rounded-full border transition-all z-20 ${
                showHint 
                  ? 'bg-[#d1fae5] text-[#076046] ' 
                  : 'bg-white/50 hover:bg-white backdrop-blur-sm text-warm-silver border-transparent hover:border-oat-light hover:text-[#12b981]'
              }`}
              aria-label={t('hint')}
          >
